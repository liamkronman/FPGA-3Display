...
@cocotb.test()
async def test_hemi_sphere_frame(dut):
    """Test hemi_sphere_frame module functionality."""
...
def hemi_sphere_frame_runner():
    """Runner function for hemi_sphere frame testbench."""
    ...
    runner.build(
        sources=sources,
        hdl_toplevel="hemi_sphere_frame",
        always=True,
    ...
    runner.test(
        hdl_toplevel="hemi_sphere_frame",
        test_module="test_hemi_sphere_frame",
        waves=True
    )


if __name__ == "__main__":
    hemi_sphere_frame_runner()